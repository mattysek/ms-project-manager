    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ado_credentials", x => new { x.project_id, x.user_id });
                    table.ForeignKey(
                        name: "FK_ado_credentials_AspNetUsers_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_files_AspNetUsers_added_by",
                        column: x => x.added_by,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_project_members_role", "role IN ('pm', 'dev')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    linked_project_id = table.Column<string>(type: "TEXT", nullable: true),
                    converted_to_task_id = table.Column<string>(type: "TEXT", nullable: true),
                    created_at = table.Column<string>(type: "TEXT", nullable: false),
                    updated_at = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_quick_notes_AspNetUsers_user_id",
                        column: x => x.user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_quick_notes_projects_linked_project_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ado_credentials_user_id",
                table: "ado_credentials",
                column: "user_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_quick_notes_linked_project_id",
                table: "quick_notes",
                column: "linked_project_id");

            migrationBuilder.CreateIndex(
                name: "IX_quick_notes_user_id",
                table: "quick_notes",
                column: "user_id");
        }
